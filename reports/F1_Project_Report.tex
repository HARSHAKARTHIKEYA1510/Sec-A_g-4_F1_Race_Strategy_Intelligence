...
\textbf{KPI} & \textbf{Formula} & \textbf{Decision Enabled} \\
\midrule
Grid-to-Finish Delta (*) & $\text{grid} - \text{positionOrder}$ & Is our race strategy making us look better or worse than qualifying? \\[6pt]
...
The \textbf{Grid-to-Finish Delta} ((*) ) is the hero metric of this project. It isolates race-day strategic execution from pure car pace, enabling apples-to-apples comparison of teams' strategic capability.
...
4 --- Circuit Intel (*) & Race Engineer & What strategy per track? & World Map with Clusters \\
\bottomrule
\end{tabularx}
\end{table}
...
\subsection{Dashboard 4: Circuit Intelligence World Map (*)}
